...
namespace worklogService.CommonMethod
{
    public class CNDate
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static int GetDayNumOfMonth(DateTime dt)
        {
            switch (dt.Month)
            {
                case 1: return 31;
        ...
        /// <summary>
        /// 得到所给参数的是时间以hh:mm的形式表现
        /// </summary>
        /// <param name="ticks">Time的Ticks</param>
        /// <returns></returns>
        public static String getTimeByTimeTicks(long ticks)
        {
            DateTime allDate = new DateTime(DateTime.Now.Date.Ticks + ticks);
            String hour = allDate.Hour.ToString().Length == 1 ? ("0" + allDate.Hour.ToString()) : allDate.Hour.ToString();
            String minute = allDate.Minute.ToString().Length == 1 ? ("0" + allDate.Minute.ToString()) : allDate.Minute.ToString();
